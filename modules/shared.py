...
options_templates.update(options_section(('ui', "Live previews"), {
    ...
    "show_progress_type": OptionInfo("Approx cheap", "Live preview method", gr.Radio, {"choices": ["Full", "Approx NN", "Approx cheap", "TAESD"]}).info("Full = slow but pretty; Approx NN and TAESD = fast but low quality; Approx cheap = super fast but terrible otherwise"),
